...
A Next.js app for Muscadine **v2** vaults on Base — Prime & Frontier strategies. Dashboard, vault explorer, and transact flows.

**Registry:** `src/lib/vaults.ts` (4 vaults today: 3 Prime + 1 USDC Frontier).  
